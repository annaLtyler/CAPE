...
plotSVD <- function(data.obj, orientation = c("vertical", "horizontal"), neg.col = "blue", pos.col =  "brown", light.dark = "f", pheno.labels = NULL, cex.barplot.axis = 1.7, cex.barplot.labels = 2, cex.barplot.title = 1.7, main = "Eigentrait Contributions to Phenotypes", cex.main = 2, main.x = 0.5, main.y = 0.5, cex.ET = 1.7, ET.label.x = 0.5, ET.label.y = 0.5, pheno.label.pos = 0.5, cex.pheno = 1.7, pheno.srt = 90, percent.total.variance.x = 0.5, percent.total.variance.y = 0.5, cex.color.scale = 1, cex.var.accounted = 2, var.accounted.x = 0, var.accounted.y = 0, show.var.accounted = FALSE){
