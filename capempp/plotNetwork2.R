...
# color.scheme = "DO/CC"; p.or.q = 0.05;  collapsed.net = TRUE; pos.col = "brown"; neg.col = "blue"; bg.col = "gray"; light.dark = "l"; node.border.lwd = 1; layout.matrix = NULL; node.radius = 1; label.nodes = TRUE; label.offset = 0; label.cex = 1; legend.radius = 1; legend.cex = 1; arrow.offset = 1; edge.lwd = 2;zoom = 1;xshift = 0;yshift = 0;arrow.length = 0.2;edge.lwd = 2;legend.position = "topleft"


plotNetwork2 <- function(data.obj, p.or.q = 0.05,  collapsed.net = TRUE, main = NULL, color.scheme = c("DO/CC", "other"), pos.col = "brown", neg.col = "blue", bg.col = "gray", light.dark = "l", node.border.lwd = 1, layout.matrix = NULL, zoom = 1, xshift = 0, yshift = 0, node.radius = 1, label.nodes = TRUE, label.offset = 0, label.cex = 1, legend.radius = 1, legend.cex = 1, legend.position = "topleft", arrow.offset = node.radius, arrow.length = 0.2, edge.lwd = 2){
