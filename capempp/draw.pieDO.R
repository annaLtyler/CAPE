...
#x = 0.5; y = 0.5; radius = 1; cols = c("red", "green"); border.col = "black"; labels = NULL; edges = 200; label.cex = 1; xlim = NULL; ylim = NULL; add = FALSE; node.border.lwd = 3

draw.pieDO <- function(x = 0.5, y = 0.5, radius = 1, cols = c("red", "green"), border.col = "black", node.border.lwd = 1, labels = NULL, edges = 200, label.cex = 1, xlim = NULL, ylim = NULL, add = TRUE){
