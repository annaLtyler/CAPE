#This function reads in a phenotype file to accompany
#the DO genotype data.
...
#filename = "SSc_phenotypes.csv"

read.pheno.cape <- function(file.format = c("cape", "csv"), filename = NULL, pheno.col = NULL, id.col = 1, delim = ",", na.strings = "-") {
