...
#transform.to.phenospace = TRUE; pval.correction = c("holm", "fdr", "lfdr"); verbose = FALSE; save.permutations = FALSE
#previously calculated permutation.data.RData perm.data can be put in the place of 
#perm.data to prevent long recalculations of permutation data
#for this data object to be saved, save.permutations should be set to TRUE

direct.influence <- function(data.obj, pairscan.obj, transform.to.phenospace = TRUE, pval.correction = c("holm", "hochberg", "hommel", "bonferroni", "BH", "BY", "fdr", "none"), verbose = FALSE, perm.data = NULL, save.permutations = FALSE, n.cores = 4, path = ".") {
