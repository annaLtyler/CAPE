...
#phenotype = NULL; standardized = FALSE; show.marker.labels = FALSE; show.chr = TRUE; label.chr = TRUE; show.alleles = TRUE; allele.labels = NULL; pos.col = "brown"; neg.col = "blue"; color.scheme = c("DO/CC", "other"); pdf.label = "Pairscan.Regression.pdf"


plotPairscan <- function(data.obj, pairscan.obj, phenotype = NULL, standardized = FALSE, show.marker.labels = FALSE, show.chr = TRUE, label.chr = TRUE, show.alleles = TRUE, allele.labels = NULL, pos.col = "brown", neg.col = "blue", color.scheme = c("DO/CC", "other"), pdf.label = "Pairscan.Regression.pdf"){
	...
	sorted.no.allele <- unlist(lapply(strsplit(sorted.markers, "_"), function(x) x[[1]][1]))
